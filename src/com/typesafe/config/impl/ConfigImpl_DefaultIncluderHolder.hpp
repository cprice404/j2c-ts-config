...
class com::typesafe::config::impl::ConfigImpl_DefaultIncluderHolder
...
private:
    static ::com::typesafe::config::ConfigIncluder* defaultIncluder_;

    // Generated

public:
    ConfigImpl_DefaultIncluderHolder();
protected:
    ConfigImpl_DefaultIncluderHolder(const ::default_init_tag&);
