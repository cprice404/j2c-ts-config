...
class com::typesafe::config::impl::ConfigString_Quoted final
    : public ConfigString
{
...
public: /* protected */
    ConfigString_Quoted* newCopy(::com::typesafe::config::ConfigOrigin* origin) override;
...
public: /* package */
    ConfigString_Quoted(::com::typesafe::config::ConfigOrigin* origin, ::java::lang::String* value);
protected:
    ConfigString_Quoted(const ::default_init_tag&);
