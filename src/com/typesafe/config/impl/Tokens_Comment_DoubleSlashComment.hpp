...
class com::typesafe::config::impl::Tokens_Comment_DoubleSlashComment final
...
public: /* package */
    Tokens_Comment_DoubleSlashComment(::com::typesafe::config::ConfigOrigin* origin, ::java::lang::String* text);
protected:
    Tokens_Comment_DoubleSlashComment(const ::default_init_tag&);
