...
class com::typesafe::config::ConfigException_Parse
...
public:
    ConfigException_Parse(ConfigOrigin* origin, ::java::lang::String* message, ::java::lang::Throwable* cause);
    ConfigException_Parse(ConfigOrigin* origin, ::java::lang::String* message);
protected:
    ConfigException_Parse(const ::default_init_tag&);
