...
class com::typesafe::config::ConfigException_BugOrBroken
...
public:
    ConfigException_BugOrBroken(::java::lang::String* message, ::java::lang::Throwable* cause);
    ConfigException_BugOrBroken(::java::lang::String* message);
protected:
    ConfigException_BugOrBroken(const ::default_init_tag&);
