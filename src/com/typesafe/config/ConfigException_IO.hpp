...
class com::typesafe::config::ConfigException_IO
...
public:
    ConfigException_IO(ConfigOrigin* origin, ::java::lang::String* message, ::java::lang::Throwable* cause);
    ConfigException_IO(ConfigOrigin* origin, ::java::lang::String* message);
protected:
    ConfigException_IO(const ::default_init_tag&);
