...
class com::typesafe::config::ConfigException_BadValue
...
public:
    ConfigException_BadValue(ConfigOrigin* origin, ::java::lang::String* path, ::java::lang::String* message, ::java::lang::Throwable* cause);
    ConfigException_BadValue(ConfigOrigin* origin, ::java::lang::String* path, ::java::lang::String* message);
    ConfigException_BadValue(::java::lang::String* path, ::java::lang::String* message, ::java::lang::Throwable* cause);
    ConfigException_BadValue(::java::lang::String* path, ::java::lang::String* message);
protected:
    ConfigException_BadValue(const ::default_init_tag&);
