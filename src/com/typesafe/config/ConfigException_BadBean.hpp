...
class com::typesafe::config::ConfigException_BadBean
...
public:
    ConfigException_BadBean(::java::lang::String* message, ::java::lang::Throwable* cause);
    ConfigException_BadBean(::java::lang::String* message);
protected:
    ConfigException_BadBean(const ::default_init_tag&);
